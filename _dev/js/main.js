...
define( [ 'gameLoop', 'Game', 'DE.imagesDatas', 'DE.audiosList', 'DE.inputsList', 'DE.dictionary', 'Popups', 'Button' ],
function( gameLoop, Game, images, audios, inputs, dictionary, Popups, Button )
{
